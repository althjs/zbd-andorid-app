# Android 즈비드 하이브리드 앱 프로젝트

이 AI 바이브코딩으로 생성된 프로젝트는 즈비드 (https://zbd.kr) 안드로이드 앱 프로젝트입니다.

- 99% 이상 바이브코딩으로 생성되었습니다.
- https://play.google.com/store/apps/details?id=kr.zbd.android
  - 스토어 정책상 비공개 테스트 완료 전 까지는 스토어에서 안보일거에요.
- 보기를 원하시는 분들은 althjs@gmail.com 로 메일 주시면, 설치를 위한 url 전달 드리겠습니다.
- 하이브리드앱 개발이 필요하신 분들께 도움이 되길 바랍니다.
- 궁금하신점은 메일 주세요 ^^a
